...
*   **📦 Package & Bloatware Manager:** Integrated `winget` GUI to search, install, and update your favorite software in bulk. Deeply debloat your system by removing pre-installed UWP telemetry apps (Cortana, TikTok, Spotify, Edge).
