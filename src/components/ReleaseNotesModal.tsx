      ...
      >
        ...
        <div className="px-6 py-4 border-b border-border flex items-center justify-between bg-surface">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                <h3 id="release-notes-modal-title" className="text-sm font-semibold text-text-primary">{t('update_modal.title', 'New Version Available')}</h3>
              ...
              {updateInfo.date && (
                <div className="flex items-center gap-1 text-[11px] text-text-muted mt-0.5 font-mono">
                  ...
                  <span>{t('update_modal.release_date', { date: updateInfo.date })}</span>
                </div>
              )}
            </div>
          </div>
          ...
          <button
            ...
            aria-label={t('update_modal.close_modal', 'Close modal')}
          >
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        <div className="p-6 overflow-y-auto flex-1 bg-background space-y-4">
          <div className="text-[11px] font-semibold uppercase tracking-wider text-text-muted pb-1 border-b border-border/60">
            {t('update_modal.changelog_title', 'Release Notes & Changelog')}
          </div>
          <MarkdownRenderer content={updateInfo.body || t('update_modal.no_notes', 'No release notes provided for this update.')} />
        </div>
        ...
        <div className="px-6 py-4 bg-surface border-t border-border flex items-center justify-between gap-3">
          <div className="text-[11px] text-text-muted hidden sm:block font-mono">
            {t('update_modal.engine_footer', 'WiScripts Utility Release Engine')}
          </div>
          <div className="flex items-center gap-3 ml-auto">
            ...
            >
              ...
              <span>{t('update_modal.remind_later', 'Remind Me Later')}</span>
            </button>
            <button
            ...
            >
              ...
              <span>{t('update_modal.install_now', 'Install Update Now')}</span>
            </button>
          </div>
        </div>
      </div>
